...
def insert_video_details(channel_id):
    try:
        ...
        for video_detail in video_details:
            date_string = video_detail['published_date'] 
            date_string = changeDateFormat(date_string)
            video_detail['published_date'] = date_string
            duration = video_detail['duration']
            duration = durationInSeconds(duration)
            video_detail['duration'] = duration
            video_detail['published_date'] = date_string
            video_detail = (video_detail['video_id'],video_detail['channel_id'],video_detail['video_name'],video_detail['video_description'],video_detail['published_date'],video_detail['view_count'],video_detail['like_count'],video_detail['favorite_count'],video_detail['comment_count'],video_detail['duration'],video_detail['thumbnail']['default']['url'],video_detail['caption_status'])
...
with st.sidebar:
    selected = st.radio("YouTube Data Harvesting and Warehousing",
        ("Home","Add Data to Database","View Tables","SQL Query")
    )
if selected == 'Home':
